...
{
    public class ServicePaths : IPathResolver
    {
        ...
        public string GetRootFolder()
        {
            ...
            var path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "FileSharing Serveri");
